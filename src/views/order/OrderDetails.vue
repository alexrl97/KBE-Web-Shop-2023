  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center" style="margin-top: 10px">
        <h4 class="pt-3">Bestellung #{{orderID}}</h4>
      </div>
    </div>
    ...
    <div v-for="(orderItem, index) in orderItems" :key="index" class="row mt-2 pt-3 justify-content-around">
      ...
      <div class="col-md-5 px-3">
        <div class="card-block px-3">
          ...
          <p id="item-price" class="mb-0 font-weight-bold">{{orderItem.product.price}}€ pro Karte</p>
          <p id="item-quantity" class="mb-0">Anzahl : {{orderItem.quantity}}</p>
